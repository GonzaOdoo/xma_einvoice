...
class ProductTemplate(models.Model):
    ...
    l10n_xma_cst_code = fields.Selection(options_cst_field, string='Tributação do ICMS')
    ...
    l10n_xma_cst_pis_code = fields.Selection(options_cst_pis_field, string='Código de Situação Tributária do PIS')
    ...
    l10n_xma_cst_cofins_code = fields.Selection(options_cst_cofins_field, string='Código de Situação Tributária do COFINS')
    ...
    l10n_xma_cst_ipi_code = fields.Selection([
        ...
        ('99', 'Outras saídas')
    ], string='Código de Situação Tributária do IPI') 

    xma_ncm_code_id = fields.Many2one('xma.ncm.code', string='Mercosul NCM Code', help='Brazil: NCM (Nomenclatura Comun do Mercosul) Code from the Mercosur List')
    xma_cest_code = fields.Char(
        string='CEST Code',
    )
    xma_source_origin = fields.Selection([
    ...
    l10n_xma_is_fuel = fields.Boolean(string="Es combustible.")
    ...
    l10n_xma_isdiscount = fields.Boolean(string="Es descuento", default=False)
